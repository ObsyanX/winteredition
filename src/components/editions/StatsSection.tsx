...
export const StatsSection: React.FC = () => {
  ...
  return <section className="relative py-24 px-6 border-y border-border/50 bg-background overflow-hidden z-20">
        ...
        duration: 0.8
          ...
          transition: {
            duration: 0.3
              ...
              <motion.div className="text-4xl md:text-5xl lg:text-6xl font-bold mb-2 bg-gradient-to-r from-editions-gold via-editions-purple to-editions-blue bg-clip-text text-transparent bg-[length:200%_auto]" whileHover={{
            ...
            transition: {
              ...
              repeatType: 'reverse'
                ...
                <CountUp end={stat.value} duration={2000} decimals={stat.decimals} suffix={stat.suffix} trigger={isVisible} />
              </motion.div>
              ...
              <motion.div className="h-0.5 bg-gradient-to-r from-editions-gold to-editions-purple mt-2 mx-auto" initial={{
            width: 0
          }} whileHover={{
            width: '50%'
          }} transition={{
...
export const SkillsShowcase: React.FC = () => {
  ...
  return <section id="skills" className="relative py-32 px-6 overflow-hidden bg-background z-20 my-[197px] mb-0">
      ...
      <div className="container mx-auto max-w-5xl relative z-10" ref={containerRef}>
        ...
        ease: [0.16, 1, 0.3, 1]
          ...
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-display mb-12">
            <Typewriter text="Skills & Expertise" speed={60} trigger={inView} cursorClassName="text-editions-gold" />
          </h2>
          ...
          }} className={cn('p-6 rounded-2xl bg-card/50 border border-border/50 backdrop-blur-sm relative overflow-hidden group cursor-default', 'before:absolute before:inset-0 before:bg-gradient-to-br before:opacity-0 before:transition-opacity before:duration-500', `before:${category.gradient}`, 'hover:before:opacity-100')}>
                {/* Animated border gradient */}
                <motion.div className={cn('absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500', `bg-gradient-to-r from-${category.color}/30 via-transparent to-${category.color}/30`)} style={{
              padding: 1
            }} />
